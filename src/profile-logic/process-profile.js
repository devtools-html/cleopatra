...
function _timeColumnToTimeDeltas(time: number[]): number[] {
...
function _processSamples(geckoSamples: GeckoSampleStruct): RawSamplesTable {
  const samples: RawSamplesTable = {
    ...
    timeDeltas: _timeColumnToTimeDeltas(geckoSamples.time),
    weightType: 'samples',
    weight: null,
...
function _processCounterSamples(
  ...
  return {
    timeDeltas: _timeColumnToTimeDeltas(geckoCounterSamples.time),
